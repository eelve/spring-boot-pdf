...
public class Html2PdfService {
    ...
    private String getCmdStr(String pageUrl, String outputPath) {
        ...
        cmdStr.append(absoultExePath).append(" --disable-smart-shrinking --load-error-handling ignore --header-line --header-center 南国薏米 ").append(pageUrl).append(" ").append(absoultOutputPath);
